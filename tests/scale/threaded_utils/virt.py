...
from utilities.constants import TIMEOUT_4MIN, TIMEOUT_8MIN
...
def threaded_wait_for_accessible_vms(vms: list[VirtualMachine]) -> list[Any]:
...
def threaded_wait_for_scheduled_vms(vms: list[VirtualMachine], wait_timeout=TIMEOUT_8MIN) -> list[Any]:
    """
